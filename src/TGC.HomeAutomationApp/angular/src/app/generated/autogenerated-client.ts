...
export class DeviceClient {
    ...
    protected processGetAllDevices(response: HttpResponseBase): Observable<DeviceResponse[]> {
        ...
        return _observableOf<DeviceResponse[]>(null as any);
    }
    ...
    getSingleDeviceById(id: string): Observable<void> {
    ...
    protected processGetSingleDeviceById(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class HumidityClient {
    ...
    protected processGetCurrentInside(response: HttpResponseBase): Observable<HumidityResponse> {
        ...
        return _observableOf<HumidityResponse>(null as any);
    }
...
export class TemperatureClient {
    ...
    protected processGetCurrentInside(response: HttpResponseBase): Observable<TemperatureResponse> {
        ...
        return _observableOf<TemperatureResponse>(null as any);
    }
